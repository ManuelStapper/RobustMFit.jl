...
# findkL(Exponential(5)^2, Tukey(4))
# findkL(Poisson(5), Tukey(4))
# findkL(Poisson(5)^2, Tukey(10))
#
# findkL(Exponential(5), Huber(2))
# findkL(Exponential(5)^2, Huber(2))
# findkL(Poisson(5), Huber(2))
# findkL(Poisson(5)^2, Huber(3))
#
# findkL(Exponential(5), Huber(2, ϵ = 0.2))
# findkL(Exponential(5)^2, Huber(2, ϵ = 0.2))
# findkL(Poisson(5), Huber(2, ϵ = 0.2))
# findkL(Poisson(5)^2, Huber(3, ϵ = 0.2))
#
# findkL(Exponential(5), Andrew(4))
# findkL(Exponential(5)^2, Andrew(10))
# findkL(Poisson(5), Andrew(4))
# findkL(Poisson(5)^2, Andrew(10))
#
# findkL(Exponential(5), Andrew(4, ϵ = 0.2))
# findkL(Exponential(5)^2, Andrew(10, ϵ = 0.1))
# findkL(Poisson(5), Andrew(4, ϵ = 0.2))
# findkL(Poisson(5)^2, Andrew(10, ϵ = 0.2))
#
# findkL(Exponential(5), Hampel([1, 2, 4]))
# findkL(Exponential(5)^2, Hampel([1, 2, 4]))
# findkL(Poisson(5), Hampel([1, 2, 4]))
# findkL(Poisson(5)^2, Hampel([1, 2, 4]))
#
# findkL(Exponential(5), Hampel([1, 2, 4], ϵ = 0.2))
# findkL(Exponential(5)^2, Hampel([1, 2, 4], ϵ = 0.2))
# findkL(Poisson(5), Hampel([1, 2, 4], ϵ = 0.2))
# findkL(Poisson(5)^2, Hampel([1, 2, 4], ϵ = 0.2))
